...
**Early implementation.** The validated `ReadRange` value type and deterministic
coalescing of overlapping or adjacent ranges exist. No schedule format, backend,
or CLI behavior does yet.
